...
//Not used anymore
@Deprecated
	  public class DummyPopUp_old  extends PopupPanel  implements hasCloseDefault, IsPopupContents,IsInventoryItemPopupContent
	  {
		// Type flag
		  ...
		  public DummyPopUp_old(String ImageDiscription, String Title)
		  {
