...
public class LandOfEdgeAndHueText extends CommonText {

	static LandOfEdgeAndHueTextResources StaticText = (LandOfEdgeAndHueTextResources) GWT
			.create(LandOfEdgeAndHueTextResources.class);
	...
	static ImmutableMap<String,TextResource> gamesInternalText = ImmutableMap.of(
			...
			"en_"+StringNames.loadingStrings.toString(),LandOfEdgeAndHueText.StaticText.enloadingStrings(),				
			"nl_"+StringNames.loadingStrings.toString(),LandOfEdgeAndHueText.StaticText.nlloadingStrings()
	); 
}
